...
# watchdog.warning = show_deprecation("watchdog_info")
# watchdog_debug = show_deprecation("watchdog_debug")
# watchdog_fatal = show_deprecation("watchdog_fatal")
# watchdog.error = show_deprecation("watchdog.error")
# watchdog.alert = show_deprecation("watchdog.alert")
...
# #watchdog.warning = watchdog_util.watchdog.warning
# #watchdog_debug = watchdog_util.watchdog_debug
# #watchdog_fatal = watchdog_util.watchdog_fatal
# #watchdog.error = watchdog_util.watchdog.error
# #watchdog.alert = watchdog_util.watchdog.alert
