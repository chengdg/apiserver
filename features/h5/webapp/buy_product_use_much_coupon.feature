...
Feature: 在webapp中使用优惠券购买商品（使用多商品券购买）
	...
	多商品优惠券
		...
		8.使用多商品券购买1个关联的商品金额小于优惠券和一个普通商品，满足条件购买成功，优惠券不抵扣普通商品的金额
		9.修改关联的部分商品名称和价格后，使用多商品券购买关联的商品，满足条件购买成功
		10.下架关联的部分商品后，使用多商品券购买关联的商品，满足条件购买成功
		11.删除关联的部分商品后，使用多商品券购买关联的商品，满足条件购买成功
		【跳转页面】
		12.从个人中心点击多商品券/点击立即使用，跳转到所关联优惠券的商品列表，title显示优惠券名称
		13.多商品券关联一个商品，商品下架后，跳转到无商品页面，显示去逛逛
		14.多商品券关联一个商品，商品删除后，跳转到无商品页面，显示去逛逛
		15.多商品券关联多个商品，商品全部下架后，跳转到无商品页面，显示去逛逛
		16.多商品券关联多个商品，商品全部删除后，跳转到无商品页面，显示去逛逛
	"""
...
@mall3 @ztq
Scenario:5 使用多商品优惠券购买关联的一个商品和一个普通商品
	1.优惠券金额大于关联的商品
	2.优惠券金额不会抵扣普通商品的金额
