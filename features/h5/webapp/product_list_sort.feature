...
Feature: webapp商品列表商品排序
	...
	开启商品排序功能后：默认排序，销量，价格
		...
		6.(商品全部列表和分组商品列表)bill第一次点击销量排序，降序-销量由大到小，如：销量一样按照添加商品正序排列
		7.(商品全部列表和分组商品列表)bill第二次点击销量排序，和第一次点击一样不变
		8.(商品全部列表和分组商品列表)bill第一次点击价格排序，上箭头变红，升序-价格由小到大，如：销量一样按照添加商品正序排列
		9.(商品全部列表和分组商品列表)bill第二次点击价格排序，下箭头变红，升序-价格由大到小，如：销量一样按照添加商品正序排列
