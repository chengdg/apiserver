...
class RWebAppOwnerInfo(inner_resource.Resource):
	"""
	商品详情
	"""
	app = 'account'
	...
	def get_from_cache(woid):
		...
		key_infos = [{
			...
			'on_miss': RWebAppOwnerInfo.get_webapp_owner_info_from_db(webapp_owner_id)
		},{
			'key': red_envelope_key,
			'on_miss': RWebAppOwnerInfo.get_red_envelope_for_cache(webapp_owner_id)
